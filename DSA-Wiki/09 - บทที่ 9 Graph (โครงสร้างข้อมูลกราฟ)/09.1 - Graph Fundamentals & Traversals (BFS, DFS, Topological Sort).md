...
### 🎯 จุดเน้นย้ำและแนวข้อสอบรั่วจากห้องเรียน (ดร.ประดิษฐ์ พิทักษ์เสถียรกุล)

> [!CAUTION]
> **1. กฎเหล็กการเขียน Path (ได้ 0 คะแนนทันทีหากใช้ลูกศร):**  
> เมื่อโจทย์สั่งให้เขียน Path จาก $A$ ไปยัง $C$  
> - ❌ ห้ามเขียน: `$A \rightarrow B \rightarrow C$` หรือ `$A \to B \to C$` (ได้ 0 คะแนนทันที!)  
> - ✅ ต้องเขียน: **`$A, B, C$`** หรือ **`(A, B, C)`** (คั่นด้วยจุลภาคเท่านั้น เพราะ Path คือ Sequence of vertices)

> [!TIP]
> **2. สูตรจำนวนเส้นของ Complete Graph (Undirected):**  
> $$E = \frac{V(V - 1)}{2}$$  
> **โจทย์ข้อสอบจริง:** กราฟมี 10 จุดยอด ($V=10$) มีกี่เส้น?  
> $$E = \frac{10 \times 9}{2} = \mathbf{45\text{ เส้น}}$$  
> *(คำเตือน: ต้องตอบเลขจำนวนเต็ม `45` ห้ามตอบติดสูตร เช่น `10*9/2` หรือ `90/2` มิฉะนั้นได้ 0 คะแนน)*

> [!IMPORTANT]
> **3. การคำนวณ Memory Waste ของ Adjacency Matrix (ข้อสอบภาษาอังกฤษ):**  
...
> สำหรับกราฟ 7 จุดยอด 12 เส้นเชื่อม (ตาราง $7 \times 7 = 49$ ช่อง):  
> - ช่องที่มีค่า 1 (เส้นเชื่อม): $\frac{12 \times 100}{49} = \mathbf{24.48\%}$  
> - ช่องที่มีค่า 0 (สูญเปล่า): $\frac{37 \times 100}{49} = \mathbf{75.51\%}$  
>  
> และสำหรับกราฟ 10 จุดยอด 20 เส้นเชื่อม:  
> - Adjacency Matrix ใช้ $10^2 = \mathbf{100\text{ ช่อง}}$  
> - Adjacency List ใช้ $20 + 10 = \mathbf{30\text{ ช่อง}}$ (ประหยัดหน่วยความจำกว่า **70%**)
...
> - 🌟 **ไฟล์เฉลยเสร็จสมบูรณ์ (Annotated PDF)**: [**`Lectures/Lecture 10 Graph/Topological sort_solved.pdf`**](../../Lectures/Lecture%2010%20Graph/Topological%20sort_solved.pdf)
> - 📖 **สารานุกรมเฉลยละเอียดรายหน้า (Wiki)**: [**`Lectures/Lecture 10 Graph/Topological_Sort_Classroom_Wiki.md`**](../../Lectures/Lecture%2010%20Graph/Topological_Sort_Classroom_Wiki.md)
