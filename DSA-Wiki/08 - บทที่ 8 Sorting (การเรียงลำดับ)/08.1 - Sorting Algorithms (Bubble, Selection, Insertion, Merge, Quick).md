...
![กระดานคำนวณ Worst Case](assets/dsa-pic/IMG_20260916_095816_275@-1897800400.jpg)

> [!TIP]
> **สูตรลัด Worst Case Position Moves (อาจารย์เน้นย้ำในห้องเรียน):**  
> เมื่อข้อมูลเรียงจากมากไปหาน้อย (Reverse Order) จะเกิด Position Move สูงสุดตามสูตรอนุกรมเลขคณิต:
> $$\text{Worst Case Moves} = \frac{N(N - 1)}{2}$$
> - สำหรับ 6 ตัว: $\frac{6 \times 5}{2} = \mathbf{15\text{ ครั้ง}}$
> - สำหรับ 8 ตัว: $\frac{8 \times 7}{2} = \mathbf{28\text{ ครั้ง}}$
> - สำหรับ 10 ตัว: $\frac{10 \times 9}{2} = \mathbf{45\text{ ครั้ง}}$
...
### 2.4 สูตรลัดคำนวณ Total Swaps ใน Bubble Sort ด้วย Inversion Counting

![ใบงานจริงวิชา DSA เรื่อง Bubble Sort](assets/dsa-pic/IMG_20260916_112712_580@-1614993214.jpg)

> [!IMPORTANT]
> **Inversion Counting Technique:**  
> การ Swap ใน Bubble Sort 1 ครั้ง จะลด Inversion (คู่ที่สลับลำดับผิด) ลง 1 คู่พอดีเสมอ  
> ดังนั้น **Total Swaps จากเริ่มจนจบ = ผลรวมของจำนวนสมาชิกทางขวาที่มีค่าน้อยกว่าตัวมันเอง**  
> ตัวอย่างอาร์เรย์ `[64, 34, 25, 12, 22, 11, 90]`:
> - 64 (5) + 34 (4) + 25 (3) + 12 (1) + 22 (1) + 11 (0) + 90 (0) = **14 ครั้ง**
...
- บันทึกถอดความเสียงสอนสดคาบ Sorting: [[14.6 - Classroom Lecture Sorting (Insertion, Selection, Bubble Sort) & Exam Inversions]]
- ใบงานเฉลย Bubble Sort ในห้องเรียน: [[12.8 - In-Class Assignment Bubble Sort Trace & Total Swaps Calculation]]
