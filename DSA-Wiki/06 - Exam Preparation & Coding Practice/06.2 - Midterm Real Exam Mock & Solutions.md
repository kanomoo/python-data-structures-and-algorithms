# 📝 06.2 - Midterm Real Exam Mock & Solutions (แนวข้อสอบกลางภาคฉบับสมบูรณ์)
...
> - **อ้างอิง:** รวบรวมจาก `New-Lectures/exam.txt`, รูปข้อสอบจริงใน `New-Lectures/Mid/`, และสไลด์การสอนทั้งหมด
